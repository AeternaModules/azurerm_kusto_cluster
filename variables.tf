...
EOT
  ...
  type = map(object({
    ...
    auto_stop_enabled                  = optional(bool) # Default: true
    disk_encryption_enabled            = optional(bool) # Default: false
    double_encryption_enabled          = optional(bool)
    outbound_network_access_restricted = optional(bool)   # Default: false
    public_ip_type                     = optional(string) # Default: "IPv4"
    public_network_access_enabled      = optional(bool)   # Default: true
    purge_enabled                      = optional(bool)   # Default: false
    streaming_ingestion_enabled        = optional(bool)   # Default: false
